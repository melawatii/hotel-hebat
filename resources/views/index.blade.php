            ...
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="/pesanReservasi" class="btn-get-started scrollto">Pesan <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                        Menginap di hotel atau penginapan yang nyaman merupakan salah satu cara terbaik untuk menikmati perjalanan, baik itu untuk liburan ataupun perjalanan bisnis. Di Hotel Hebat, Anda bisa dengan mudah menemukan hotel atau penginapan yang tepat plus sesuai bujet, mulai dari hotel murah, boutique hotel, hingga hotel bintang 5. Nah, momen mencari hotel terbaik ini juga menjadi hal yang penting, khususnya bagi Anda yang berencana liburan bersama keluarga. Anda perlu melengkapi informasi mengenai fasilitas dan keunikan yang ditawarkan dari masing-masing hotel untuk menyesuaikannya dengan kebutuhan Anda.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section id="kamar" class="services">
            <div class="container">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p><strong>Terdiri dari beberapa jenis fasilitas kamar berdasarkan jumlah tempat tidur :</strong></p>
                </div>
                                        ...
                                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                                            <div class="count-box">
                                                ...
                                                <p>
                                                    ...
                                                    terdiri dari satu ruangan yang berisi satu tempat tidur, sofa, dan kamar mandi.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                                            <div class="count-box">
                                                ...
                                                <p>
                                                    ...
                                                    terdiri dari dua tempat tidur yang disatukan dan diletakkan berdampingan.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                                        ...
                                        <div class="col-md-6 d-md-flex align-items-md-stretch">
                                            <div class="count-box">
                                                ...
                                                <p>
                                                    ...
                                                    terdiri dari satu tempat tidur besar dan kecil, dan ruangan lebih besar.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/homepage/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
                                    <h3>Saul Goodman</h3>
                                    <h4>Ceo &amp; Founder</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Akses lokasi strategis. Kamar luas dengan kebersihan yg baik. Kamar tersedia sabun, handuk, keset, ketel, listrik, air mineral dan set gelas.
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/homepage/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Ini adalah hotel yang nyaman, apabila ada fasilitas breakfast akan lebih baik, kebersihan perlu di jaga, taman yang menjadi spot menarik dari hotel ini perlu di pelihara.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/homepage/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Hotelnya bersih walaupun terlihat seperti bangunan lama, deket ke destinasi wisata terutama di pusat kota, anak-anak happy apalagi ada kolam renangnya, mudah mencari jajanan.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/homepage/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Kamarnya cukup luas, ruangan terbuka, kolam renang bersih, lokasi dalam kota. Cocok untuk keluarga dan anak. Makan pun bisa di kamar, pinjam peralatan makan hotelnya.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-wrap">
                                <div class="testimonial-item">
                                    <img src="assets/homepage/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                    <p>
                                        <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                        Lokasi yang dekat kemana mana, bisa jalan kaki ke kuliner, oleh oleh, staffnya baik, mobil selalu sudah bersih dipagi hari, kebersihan baik.
                                        <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-about">
                            <h3>Hotel Hebat</h3>
                            <p>adalah tempat yang sempurna untuk masa inap yang nyaman serta pertemuan bisnis, konferensi, dan pelatihan.</p>
                    ...
                    <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                        <div class="info">
                            ...
                            <div>
                                ...
                                <p>hotline@hotelhebat.com</p>
                            </div>
                            <div>
                                <i class="ri-phone-line"></i>
                                <p>+1 2345 67890 00s</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" requiredap>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" requiredap>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" requiredap>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="message" rows="5" placeholder="Message" requiredap></textarea>
                            </div>
                            <div class="my-3">
